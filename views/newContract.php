<div class="container">
<?php if(User::whoisUser()=='Owner'):?><h2>Новая заявка<?php if($this->aData['CurrentCont']['status']==0): ?><span class="glyphicon glyphicon-hourglass fa-1x"><?php endif; ?>
    <?php if($this->aData['CurrentCont']['status']==1): ?><span class="glyphicon glyphicon-ok fa-1x"><?php endif; ?>
    <?php if($this->aData['CurrentCont']['status']==2): ?><span class="glyphicon glyphicon-ban-circle fa-1x"><?php endif; ?></h2><? else: ?><h2>Ваш заказ</h2><?php endif; ?>
